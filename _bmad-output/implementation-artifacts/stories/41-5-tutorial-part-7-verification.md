...
2. Tutorial notes where the `locale` plugin is a stub (permissions + menu only, no translation UI) -- sets expectations correctly
...
- [ ] Add or update section demonstrating `format_date` with `locale` parameter (AC: #3)
