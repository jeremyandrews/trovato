...
- [Web Layer & Sessions](Design-Web-Layer.md) — HTTP routing, middleware, sessions, authentication (Sections 1-2)
- [Plugin & Tap System](Design-Plugin-System.md) — WASM plugin loading, tap dispatch, SDK (Sections 3-4)
- [Render Tree & Forms](Design-Render-Theme.md) — JSON render pipeline, Form API (Sections 5, 10)
- [Content Model](Design-Content-Model.md) — Items/CCK, stages, revisions, categories (Sections 6-8)
- [Gather Query Engine](Design-Query-Engine.md) — Dynamic query builder (Section 9)
- [Infrastructure](Design-Infrastructure.md) — Files, cron, search, caching, error handling (Sections 11-15)
- [Project Meta](Design-Project-Meta.md) — Benchmarks, migration, project structure, dependencies, roadmap, decisions, gaps (Sections 16-23)
- [Plugin SDK Spec](Design-Plugin-SDK.md) — Types, macros, host functions, WIT interface, mutation model, complete examples
