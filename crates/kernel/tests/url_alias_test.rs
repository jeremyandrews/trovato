...
#[test]
fn test_alias_create_and_lookup() {
    run_test(async {
...
#[test]
fn test_alias_multiple_for_same_source() {
    run_test(async {
        let app = shared_app().await;
...
#[test]
fn test_alias_delete_by_source() {
    run_test(async {
        let app = shared_app().await;
...
#[test]
fn test_e2e_middleware_rewrites_alias_to_source() {
    run_test(async {
        let app = shared_app().await;
...
#[test]
fn test_e2e_middleware_passthrough_for_non_alias() {
    run_test(async {
        let app = shared_app().await;
...
#[test]
fn test_e2e_middleware_skips_system_paths() {
    run_test(async {
        let app = shared_app().await;
...
#[test]
fn test_e2e_admin_alias_list_requires_auth() {
    run_test(async {
        let app = shared_app().await;
...
#[test]
fn test_e2e_middleware_preserves_query_string() {
    run_test(async {
        let app = shared_app().await;
