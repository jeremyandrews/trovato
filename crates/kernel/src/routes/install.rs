...
<head>
    ...
    <!-- The installer renders its own shell rather than extending base.html, so
         the favicon links are repeated here. Keep them in step with
         templates/base.html. -->
