...
-- Categories
ALTER TABLE categories ADD COLUMN IF NOT EXISTS tenant_id UUID NOT NULL DEFAULT '0193a5a0-0001-7000-8000-000000000001' REFERENCES tenant(id);
...
ALTER TABLE comments ADD COLUMN IF NOT EXISTS tenant_id UUID NOT NULL DEFAULT '0193a5a0-0001-7000-8000-000000000001' REFERENCES tenant(id);
